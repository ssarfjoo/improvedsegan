...
def read_and_decode(filename_queue, canvas_size):
    ...
    features = tf.parse_single_example(
            ...
            features={
                ...
                'baseline_raw': tf.FixedLenFeature([], tf.string),
            })
    ...
    baseline = tf.decode_raw(features['baseline_raw'], tf.int32)
    baseline.set_shape(canvas_size)
    baseline = (2./65535.) * tf.cast((baseline - 32767), tf.float32) + 1.

    return wave, noisy, baseline 
